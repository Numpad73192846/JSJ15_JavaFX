...
public class MainController {
    ...
    void delete(ActionEvent event) {
    	...
    	System.out.println(count + "건의 게시글 식제 완료!");
    	if( count > 0 ) {
    		boardList = boardService.list();
